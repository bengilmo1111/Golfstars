...
Built with plain HTML5 Canvas + JavaScript. **No build step and no backend**; the game can ship a small manually supplied set of illustrated WebP background images with procedural gradient fallbacks, while characters, props, HUD, effects, and sounds remain procedural or synthesised at runtime.

See [`docs/PRD.md`](docs/PRD.md) for the full product spec.

## Play it

Because the game is just static files, you can open it a few ways. If you have the optional illustrated background pack, copy its WebP files into `assets/` before serving or deploying; missing files automatically fall back to procedural backgrounds.
